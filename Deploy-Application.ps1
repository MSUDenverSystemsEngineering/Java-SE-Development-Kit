...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'eclipse,firefox,iexplore,netbeans,netbeans64,sqldeveloper' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		Write-Log -Message "Searching for any previous JDK versions to remove prior to installation..." -Severity 1 -Source $deployAppScriptFriendlyName
		...
		$exitCode = Execute-Process -Path "jdk-12.0.2_windows-x64_bin.exe" -Parameters "/s" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'eclipse,firefox,iexplore,netbeans,netbeans64,sqldeveloper' -CloseAppsCountdown 60
		...
		Execute-MSI -Action Uninstall -Path '{3FA68A00-9C88-5E69-870A-B40CB89DC2EF}'
